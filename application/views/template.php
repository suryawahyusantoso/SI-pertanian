                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?php echo base_url()?>assets/layouts/layout/img/" />
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    ...
                                    <li>
                                        <a href="app_calendar.html">
                                            <i class="icon-basket"></i> Keranjang </a>
                                    </li>
                                    <li class="divider"> </li>
                                    <li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                  ...
                                  foreach ($main_menu->result() as $main) {
                                      // Query mencari data sub menu
                                      $sub_menu = $this->db->get_where('tabel_menu', array('is_main_menu' => $main->id));
                                      // periksa menu
                                      if ($sub_menu->num_rows() > 0){
                                          // sub menu
                                          foreach ($sub_menu->result() as $sub) {
                                            echo "<li class='nav-item'>" . anchor($sub->link, '<i class"' . $sub->icon . '"></i>' . $sub->judul_menu) . "</li>";
                                          }
                                      }
                                  }
                                  ?>
...
<![endif]-->
        ...
        <script src="<?php echo base_url()?>assets/pages/scripts/ecommerce-orders-view.min.js" type="text/javascript"></script>
